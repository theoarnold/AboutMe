...
namespace AboutMe.Migrations
{
    ...
    [Migration("20240401182445_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AboutMe.Data.ApplicationInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AboutMe.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AboutMe.Data.ButtonInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ButtonColourHex")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AboutMe.Data.ButtonInfo", b =>
                {
                    b.HasOne("AboutMe.Data.ApplicationInfo", "ApplicationInfo")
                        .WithMany("Buttons")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AboutMe.Data.ApplicationUser", null)
                        .WithMany()
